...
describe "UntitledTestCase" do
  ...
  it "test_untitled_test_case" do
    ...
    @driver.find_element(:id, "vPEST_ID").send_keys("2005", :tab)
    sleep 3
    @driver.find_element(:id, "CTLSELECCIONA_0001").click
    @driver.find_element(:id, "BUTTON1").click
    sleep 3
    Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "vSOL_PACIENTETIPODOCD")).select_by(:text, "DOCUMENTO DE IDENTIDAD")
