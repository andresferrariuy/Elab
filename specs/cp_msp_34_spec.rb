...
describe "UntitledTestCase" do
  ...
  it "test_untitled_test_case" do
    ...
    Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "vSOLICITUDESTADO")).select_by(:text, "Enviado")
    @driver.find_element(:id, "IMAGE1").click
    sleep 5
    @driver.find_element(:id, "vSOLICITUDESTADO").click
    Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "vSOLICITUDESTADO")).select_by(:text, "Recibido")
    @driver.find_element(:id, "IMAGE1").click
    sleep 5
    @driver.find_element(:id, "vSOLICITUDESTADO").click
    Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "vSOLICITUDESTADO")).select_by(:text, "En Proceso")
    @driver.find_element(:id, "IMAGE1").click
    sleep 5
    @driver.find_element(:id, "vSOLICITUDESTADO").click
    Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "vSOLICITUDESTADO")).select_by(:text, "Finalizado")
    @driver.find_element(:id, "IMAGE1").click
    sleep 5
    @driver.find_element(:id, "vSOLICITUDESTADO").click
    Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "vSOLICITUDESTADO")).select_by(:text, "En Transito")
    @driver.find_element(:id, "IMAGE1").click
    sleep 5
    @driver.find_element(:id, "vSOLICITUDESTADO").click
    Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "vSOLICITUDESTADO")).select_by(:text, "Anulado")
    @driver.find_element(:id, "IMAGE1").click
    sleep 5
    @driver.find_element(:id, "vSOLICITUDESTADO").click
